...
static inline OBX_model* create_obx_model() {
    ...
    obx_model_entity(model, "Task", 1, 8639300158879607095);
    obx_model_property(model, "id", OBXPropertyType_Long, 1, 3998250669714121362);
    obx_model_property_flags(model, OBXPropertyFlags_ID);
    obx_model_property(model, "text", OBXPropertyType_String, 2, 4469057070675859163);
    obx_model_property(model, "date_created", OBXPropertyType_Long, 3, 448080608365323827);
    obx_model_property_flags(model, OBXPropertyFlags_UNSIGNED);
    obx_model_property(model, "date_finished", OBXPropertyType_Long, 4, 1358219143385437873);
    obx_model_property_flags(model, OBXPropertyFlags_UNSIGNED);
    obx_model_entity_last_property_id(model, 4, 1358219143385437873);
    
    obx_model_last_entity_id(model, 1, 8639300158879607095);
